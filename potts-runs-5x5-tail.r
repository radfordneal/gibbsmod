# 5x5 POTTS EXPERIMENTAL RUNS - TAIL COMMANDS.
#
# Included by potts-runs-5x5-a.r, potts-runs-5x5-b.r, etc. after some 
# variables are set.
...
save (res, file=paste0("runs/potts-res-5x5-",rtype,runn), version=2)
